...
use crate::flags::{
    clone_flags_to_str, dir_fd_to_str, file_mode_to_str, open_flags_to_str, rename_flags_to_str,
};
...
impl fmt::Display for SyscallArgument {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            SyscallArgument::RenameFlags(flags) => write!(f, "{}", rename_flags_to_str(*flags)),
        }
    }
}
